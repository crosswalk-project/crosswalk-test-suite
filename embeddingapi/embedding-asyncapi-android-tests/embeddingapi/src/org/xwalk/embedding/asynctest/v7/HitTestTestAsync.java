...
import org.xwalk.embedding.base.XWalkViewInternalTestBase;
import org.xwalk.embedding.util.CommonResources;
import org.xwalk.embedding.util.XWalkViewInternalTestTouchUtils;

public class HitTestTestAsync extends XWalkViewInternalTestBase {
    ...
    private void srcPhoneTypeTestBody(boolean byTouch) throws Throwable {
        ...
        String prefix = "tel:";
        String page = fullPageLink(prefix + phone_num, ANCHOR_TEXT);
        setServerResponseAndLoad(page);
        simulateInput(byTouch);
