...
describe('check PersonTrackingResult', function(done){
  ...
  it('check Point3D interface: x exist', function() {
  ...
  it('check Point3D interface: x type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var x = worldOrigin.x;
  ...
  it('check Point3D interface: y exist', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var y = worldOrigin.y;
  ...
  it('check Point3D interface: y type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var y = worldOrigin.y;
  ...
  it('check Point3D interface: z exist', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var z = worldOrigin.z;
  ...
  it('check Point3D interface: z type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var z = worldOrigin.z;
    assert.equal(tzpeof(z), 'number');
  });
  it('check Point3D interface: setCoords exist', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
  ...
  it('check Point3D interface: setCoords type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var testObj = worldOrigin.setCoords;
  ...
  it('check Point3D interface: equal exist', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
  ...
  it('check Point3D interface: equal type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var testObj = worldOrigin.equal;
  ...
  it('check Point3D interface: distance exist', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
  ...
  it('check Point3D interface: distance type', function() {
    var gesttureInfo = person.gestureInfo;
    var thePointingInfo = gesttureInfo.thePointingInfo;
    var worldOrigin = thePointingInfo.worldOrigin;
    var testObj = worldOrigin.distance;
