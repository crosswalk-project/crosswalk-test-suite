	...
	TestRunner.prototype = (function () {
		...
		return {
			...
			getListInfo: function () {
				...
				var data = "<html><head><style>.category{background: #cccccc;border: 1px solid #aaaaaa;} li{list-style-type: none; padding-left: 0.6em; padding-bottom:0.8em; font-size: 1.3em;}html{font-family:DejaVu Sans, Bitstream Vera Sans, Arial, Sans;}</style></head><body leftmargin=40>";
			...
			getBrowseInfo: function () {
				...
				data += "html{font-family:DejaVu Sans, Bitstream Vera Sans, Arial, Sans;}</style></head><body leftmargin=40>";
				if (notrunList)
