...
*/
	...
	{name: "Class selector, matching element with class value using non-ASCII characters",                    selector: ".台北Táiběi",             expect: ["class-span1"],               level: 1, testType: TEST_QSA_BASELINE | TEST_MATCH_BASELINE},
	...
	{name: "Class selector, chained, matching element with multiple class values using non-ASCII characters", selector: ".台北Táiběi.台北",          expect: ["class-span1"],               level: 1, testType: TEST_QSA_BASELINE | TEST_MATCH_BASELINE},
