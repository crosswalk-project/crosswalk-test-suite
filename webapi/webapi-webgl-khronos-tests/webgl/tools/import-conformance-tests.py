...
PATCHES = [
    ...
    ("unit_css.patch", "conformance/more/unit.css"),
    ("unit_js.patch", "conformance/more/unit.js")
]
...
def main():
    ...
    for patch, file_name in PATCHES:
        try:
            ...
            print("Please review the crosswalk-test-suite integration and update {} accordingly".format(os.path.basename(patch)))
