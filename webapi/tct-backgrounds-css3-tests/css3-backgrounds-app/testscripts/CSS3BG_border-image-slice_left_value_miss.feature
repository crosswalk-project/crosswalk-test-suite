Feature: css3-backgrounds
 Scenario: CSS3BG border image slice left value miss
   When launch "css3-backgrounds-app"
     ...
     And I save the screenshot md5 as "CSS3BG_border-image-slice_left_value_miss"
    Then file "CSS3BG_border-image-slice_left_value_miss" of baseline and result should be the same
