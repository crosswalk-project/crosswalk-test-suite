...
SubApkSrc1=$BUILD_ROOT/application/support/TCTAppControl
SubApkSrc2=$BUILD_ROOT/application/support/TCTAppControlMock
SubApkDir1=`basename $SubApkSrc1`
SubApkDir2=`basename $SubApkSrc2`
SubApkName1=$SubApkDir1
SubApkName2=$SubApkDir2
...
SubXpkSrc1=$BUILD_ROOT/application/support/TCTAppControl
SubXpkSrc2=$BUILD_ROOT/application/support/TCTAppControlMock
SubXpkDir1=`basename $SubXpkSrc1`
SubXpkDir2=`basename $SubXpkSrc2`
SubXpkName1="TCTAppControl"
SubXpkName2="TCTAppControlMock"
...
cd $BUILD_ROOT
python make_xpk.py $BUILD_DEST/$SubXpkDir1 key1
python make_xpk.py $BUILD_DEST/$SubXpkDir2 key2
