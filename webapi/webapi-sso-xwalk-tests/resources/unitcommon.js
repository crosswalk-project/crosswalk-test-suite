 ...
 * Example usage:
 * checkExtraArgument(tizen.sso, "removeAll");
 *
 * @param object object
 ...
 * Example usage:
 * check_readonly(statussso, "postedTime", null, 'object', new Date());
 *
 ...
 * Example usage:
 * check_method_exists(tizen.sso, "get");
 *
