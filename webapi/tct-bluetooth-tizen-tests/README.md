...
you MUST modify "REMOTE_DEVICE_ADDRESS", "REMOTE_DEVICE_NAME" and "REMOTE_HEALTH_DEVICE_TYPE" in bluetooth/support/bluetooth_common.js before making RPM package.
    "REMOTE_DEVICE_ADDRESS" : The address of the device on which tct-bt-helper will be run.
