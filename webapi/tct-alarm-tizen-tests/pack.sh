...
SubApkSrc=$BUILD_ROOT/alarm/support/UnitTest-AlarmTest1
...
SubXpkSrc=$BUILD_ROOT/alarm/support/UnitTest-AlarmTest1
SubXpkDir=`basename $SubXpkSrc`
SubXpkName="alarmTestApp"
...
cd $BUILD_ROOT
python make_xpk.py $BUILD_DEST/$SubXpkDir key2
