...
//@{
	if (mx.length == 0) {
		assert_regexp_match(getComputedStyle(div)[prefixProp("transform")],
                                                      //add to accept matrix(2, 0, 0, 2, 0, 0) and matrix3d(2, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1, -0.01, 0, 0, 0, 1) values when parse error.
			///^(none|matrix\(1, 0, 0, 1, 0, 0\))$/,
                                                      /^(none|matrix\(1, 0, 0, 1, 0, 0\)|matrix\(2, 0, 0, 2, 0, 0\)|matrix3d\(2, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1, -0.01, 0, 0, 0, 1\))$/,
