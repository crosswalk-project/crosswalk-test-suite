...
if not os.path.isdir("/opt/usr/media/tct/opt/Crosswalk-Manifest-Check"):
   print "not /opt/usr/media/tct/opt/Crosswalk-Manifest-Check. Please pack.sh -> unzip .zip->inst.sh "
   sys.exit(1)
else:
   os.chdir("/opt/usr/media/tct/opt/Crosswalk-Manifest-Check/") 
   path = os.getcwd()
   print path
   path_tcs = path + "/tcs"
   ...
   report_file = report_path + "/Crosswalk-Manifest-Check.xml"
