...
3. run test case
   testkit-lite -f [testprefix-path]/opt/wrt-manifest2-android-tests/tests.xml -A -o [testprefix-path]/opt/wrt-manifest2-android-tests/result.xml --comm localhost --testenvs "DEVICE_ID=Medfield3C6DFF2E;CONNECT_TYPE=adb" --testprefix=[testprefix-path], DEVICE_ID can also be multiple ids like "DEVICE_ID=Medfield3C6DFF2E,Medfield3C6DFF00".
