...
3. ./inst.py -i
4. run test case
   testkit-lite -f [testprefix-path]/opt/wrt-extension-android-tests/tests.xml -A -o [testprefix-path]/opt/wrt-extension-android-tests/result.xml --comm localhost --testprefix [testprefix-path]
   --testenvs "DEVICE_ID=Medfield3D5BD1C7 CONNECT_TYPE=adb".
