Feature: Embedding api usecase tests
    Scenario: Multi_Tab_WebView_Video
        When I launch "stability-embeddingapi-android-tests" with "org.xwalkview.stability.app" and "TabVideoWebViewsActivity" on android
