Feature: Embedding api usecase tests
    Scenario: Multi_Tab_WebView_Website
        When I launch "stability-embeddingapi-android-tests" with "org.xwalkview.stability.app" and "TabWebViewsActivity" on android
