Feature: Embedding api usecase tests
    Scenario: Multi_XWalkView_Video
        When I launch "stability-embeddingapi-android-tests" with "org.xwalkview.stability.app" and "VideoXWalkViewsActivity" on android
