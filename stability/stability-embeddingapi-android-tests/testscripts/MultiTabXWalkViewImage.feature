Feature: Embedding api usecase tests
    Scenario: Multi_Tab_XWalkView_Image
        When I launch "stability-embeddingapi-android-tests" with "org.xwalkview.stability.app" and "TabImageXWalkViewsActivity" on android
