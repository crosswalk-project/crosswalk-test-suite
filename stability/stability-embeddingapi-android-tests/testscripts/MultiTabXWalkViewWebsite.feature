Feature: Embedding api usecase tests
    Scenario: Multi_Tab_XWalkView_Website
        When I launch "stability-embeddingapi-android-tests" with "org.xwalkview.stability.app" and "TabXWalkViewsActivity" on android
