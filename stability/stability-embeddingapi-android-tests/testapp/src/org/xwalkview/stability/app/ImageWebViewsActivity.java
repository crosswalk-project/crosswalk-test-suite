...
public class ImageWebViewsActivity extends XWalkBaseImageActivity {

    @Override
    protected void onXWalkReady() {
        setContentView(R.layout.view_maximum);
        textDes.setText("This sample demonstrates the feasibility to create and destroy many WebViews at same time to load webpages with image contents.");
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(views_num_text.getText())){
                    ...
                    for(int i = view_num; i < max_num; i++) {
                        ...
                        WebView webView = new WebView(ImageWebViewsActivity.this);
                        webView.setId(i);
