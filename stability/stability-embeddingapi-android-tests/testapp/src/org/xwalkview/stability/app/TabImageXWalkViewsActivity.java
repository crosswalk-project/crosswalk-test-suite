...
public class TabImageXWalkViewsActivity extends XWalkBaseTabImageActivity {

    @Override
    protected void onXWalkReady() {
        textDes.setText("This sample demonstrates the feasibility to create and destroy XWalkViews in many tabs (1 xwalkview per tab) at same time to load webpages with image contents.");
                    ...
                    for(int i = view_num; i < max_num; i++) {
                        ...
                        tab1.setContent(new TabContentFactory(){
                            ...
                            public View createTabContent(String tag) {
                                XWalkView mXWalkView = new XWalkView(TabImageXWalkViewsActivity.this, TabImageXWalkViewsActivity.this);
