...
public class AutoMultiXWalkViewsActivity extends XWalkBaseActivity {

    @Override
    protected void onXWalkReady() {
        textDes.setText("This sample demonstrates the feasibility to repeat many times to create and destory several xwalkviews at same times.");
        views_num_text.setText(VIEWS_NUM_FIVE);
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(views_num_text.getText())){
                    ...
                    for(int i = view_num; i < max_num; i++) {
                        ...
                        XWalkView mXWalkView = new XWalkView(AutoMultiXWalkViewsActivity.this, AutoMultiXWalkViewsActivity.this);
                        mXWalkView.setId(i);
                        ...
                        System.out.println(view_root.getHeight() - i * 10);
