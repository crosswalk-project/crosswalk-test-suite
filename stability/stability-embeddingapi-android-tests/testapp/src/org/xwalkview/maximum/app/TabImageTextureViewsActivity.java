...
import org.xwalkview.maximum.base.XWalkBaseTabImageActivity;
...
public class TabImageTextureViewsActivity extends XWalkBaseTabImageActivity {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    tab1.setContent(new TabContentFactory(){
                        ...
                        public View createTabContent(String tag) {
                            XWalkView mXWalkView = new XWalkView(TabImageTextureViewsActivity.this, TabImageTextureViewsActivity.this);
