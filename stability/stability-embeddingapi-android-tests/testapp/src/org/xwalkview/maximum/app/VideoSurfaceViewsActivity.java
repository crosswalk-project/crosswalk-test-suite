...
public class VideoSurfaceViewsActivity extends XWalkBaseVideoActivity {
        ...
        mAddViewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    XWalkView mXWalkView = new XWalkView(VideoSurfaceViewsActivity.this, VideoSurfaceViewsActivity.this);
