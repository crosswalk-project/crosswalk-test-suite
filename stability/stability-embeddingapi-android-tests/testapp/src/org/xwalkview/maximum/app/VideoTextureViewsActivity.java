...
public class VideoTextureViewsActivity extends XWalkBaseVideoActivity {
        ...
        mAddViewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    XWalkView mXWalkView = new XWalkView(VideoTextureViewsActivity.this, VideoTextureViewsActivity.this);
