...
public class ImageSurfaceViewsActivity extends XWalkBaseImageActivity {
        ...
        mAddViewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    XWalkView mXWalkView = new XWalkView(ImageSurfaceViewsActivity.this, ImageSurfaceViewsActivity.this);
