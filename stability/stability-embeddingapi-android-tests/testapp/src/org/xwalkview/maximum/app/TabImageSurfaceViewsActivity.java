...
public class TabImageSurfaceViewsActivity extends XWalkBaseTabImageActivity {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    tab1.setContent(new TabContentFactory(){
                        ...
                        public View createTabContent(String tag) {
                            XWalkView mXWalkView = new XWalkView(TabImageSurfaceViewsActivity.this, TabImageSurfaceViewsActivity.this);
