...
public class TabSurfaceViewsActivity extends XWalkBaseTabActivity {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    tab1.setContent(new TabContentFactory(){
                        ...
                        public View createTabContent(String tag) {
                            XWalkView mXWalkView = new XWalkView(TabSurfaceViewsActivity.this, TabSurfaceViewsActivity.this);
