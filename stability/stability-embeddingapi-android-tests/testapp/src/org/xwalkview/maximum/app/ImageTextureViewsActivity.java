...
import org.xwalkview.maximum.base.XWalkBaseImageActivity;

import android.os.Bundle;
import android.text.TextUtils;
import android.view.View;

public class ImageTextureViewsActivity extends XWalkBaseImageActivity {
        ...
        mAddViewsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = view_num; i < max_num; i++) {
                    ...
                    XWalkView mXWalkView = new XWalkView(ImageTextureViewsActivity.this, ImageTextureViewsActivity.this);
