Feature: Embedding api usecase tests
    Scenario: get API version and xwalk version
        When I launch "usecase-embedding-android-test" with "org.xwalk.embedded.api.asyncsample" and "extended.XWalkViewWithWindowsVisibilityChangedAsync" on android
