Feature: Embedding api usecase tests
    Scenario: Check xwalk pause & resume js time
        When I launch "usecase-embedding-android-test" with "org.xwalk.embedded.api.sample" and "basic.XWalkViewWithPauseTimer" on android
         And I register watcher "ClearInfoWindow" when "Info" click "confirm"
         And I force to run all watchers
         And I wait for 3 seconds
         And I click view "resourceId=org.xwalk.embedded.api.sample:id/pause"
