Feature: Embedding api usecase tests
    Scenario: load icon when it's available
        When I launch "usecase-embedding-android-test" with "org.xwalk.embedded.api.asyncsample" and "client.XWalkViewWithOnIconAvailableOnReceivedIconAsync" on android
