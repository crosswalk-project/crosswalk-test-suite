...
### 58. The [XWalkViewWithClearCacheForSingleFile](XWalkViewWithClearCacheForSingleFile.java) sample check XWalkView can implement clearCacheForSingleFile API, include:
