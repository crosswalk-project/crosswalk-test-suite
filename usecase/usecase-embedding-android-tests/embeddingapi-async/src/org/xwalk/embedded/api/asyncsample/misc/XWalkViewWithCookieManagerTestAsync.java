...
public class XWalkViewWithCookieManagerTestAsync extends Activity implements XWalkInitializer.XWalkInitListener {
    private static final String TAG = XWalkViewWithCookieManagerTestAsync.class.getSimpleName();
