...
public class CookieManagerTestActivity extends Activity implements XWalkInitializer.XWalkInitListener {
    private static final String TAG = CookieManagerTestActivity.class.getSimpleName();
