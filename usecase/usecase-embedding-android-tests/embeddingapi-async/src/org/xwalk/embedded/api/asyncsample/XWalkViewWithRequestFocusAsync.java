...
public class XWalkViewWithRequestFocusAsync extends Activity implements XWalkInitializer.XWalkInitListener, MessageInfoXWalkView.MessageListener{
    ...
    public void onXWalkInitCompleted() {
        setContentView(R.layout.activity_xwalk_view_with_request_focus_async);
