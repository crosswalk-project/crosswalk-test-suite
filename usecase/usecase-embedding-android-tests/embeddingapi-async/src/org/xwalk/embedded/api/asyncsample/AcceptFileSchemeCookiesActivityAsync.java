...
public class AcceptFileSchemeCookiesActivityAsync extends Activity implements XWalkInitializer.XWalkInitListener {
	private static final String TAG = AcceptFileSchemeCookiesActivityAsync.class.getSimpleName();
    private String url;
