...
public class XWalkViewWithResourceAndUIClientAsync extends Activity implements XWalkInitializer.XWalkInitListener {
    private XWalkView mXWalkView;
    private EditText mText;
    private XWalkInitializer mXWalkInitializer;
    private static final String TAG = XWalkViewWithResourceAndUIClientAsync.class.getName();
